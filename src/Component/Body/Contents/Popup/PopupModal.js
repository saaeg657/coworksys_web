...
export default class PopupModal extends React.Component {
    ...
    closePopup() {
        ...
        this.props.parent.ContentsArea.props.Body.props.ViewManager.MovePage("automator", "automator");
    }
    changeMessage(e) {
    ...
    close() {
        ...
        if (this.props.PopupManager == undefined) {
            this.props.parent.props.ContentsArea.refresh_automator();
            return;
        }
        ...
        switch (this.state.popuptype) {
            ...
            case "delete_usergroup":
                ...
                APIManager.requestAPI(
                    ...
                    this.responseAPICallback_done,
                    newAPI.get("apilistkey"));
                this.showMessage("사용자 조직이 삭제되었습니다.");
                break;
            case "delete_group":
                for (var i = 0; i < CommonData.bulkactionList.length; i++) {
                    IDlist = IDlist.concat(CommonData.bulkactionList[i].id)
                ...
                APIManager.requestAPI(
                    ...
                    this.responseAPICallback_done,
                    newAPI.get("apilistkey"));
                this.showMessage("장치 조직이 삭제되었습니다.");
                break;
            case "delete_agent":
                for (var i = 0; i < CommonData.bulkactionList.length; i++) {
                    IDlist = IDlist.concat(CommonData.bulkactionList[i].id)
                ...
                APIManager.requestAPI(
                    ...
                    this.responseAPICallback_done,
                    newAPI.get("apilistkey"));
                this.showMessage("에이전트가 삭제되었습니다.");
                break;
            case "delete_device":
                for (var i = 0; i < CommonData.bulkactionList.length; i++) {
                    IDlist = IDlist.concat(CommonData.bulkactionList[i].id)
            ...
            case "sendmessage":
                ...
                APIManager.requestAPI(
                    ...
                    this.responseAPICallback_done,
                    newAPI.get("apilistkey"));
                this.showMessage("장치로 메세지가 전달되었습니다.");
                break;
            case "publish":
                for (var i = 0; i < CommonData.bulkactionList.length; i++) {
                    IDlist = IDlist.concat(CommonData.bulkactionList[i].id)
                ...
                if (active) {
                    ...
                    newAPI.put(
                        "/coworksys", "/api/agentGroup/stop", util.getDefaultHeader(),
                        {
                            "agentGroupIDList": IDlist
                        },
                        null,
                ...
                APIManager.requestAPI(
                    ...
                    this.responseAPICallback_done,
                    newAPI.get("apilistkey"));
                this.showMessage(active ? "에이전트가 배포 상태로 변경되었습니다." : "에이전트가 배포 중지 상태로 변경되었습니다.");
                break;
            case "update":
                for (var i = 0; i < CommonData.bulkactionList.length; i++) {
                    IDlist = IDlist.concat(CommonData.bulkactionList[i].id)
                ...
                APIManager.requestAPI(
                    ...
                    this.responseAPICallback_done,
                    newAPI.get("apilistkey"));
                this.showMessage("에이전트가 배포상태로 변경되었습니다.");
                break;
            case "activate":
                var active = false;
                for (var i = 0; i < CommonData.bulkactionList.length; i++) {
                ...
                if (active)
                    this.showMessage("사용자가 활성화되었습니다.");
                else
                    this.showMessage("사용자가 비활성화되었습니다.");
                break;
            case "delete_automator":
                ...
                APIManager.requestAPI(
                    ...
                    this.responseAPICallback_done,
                    newAPI.get("apilistkey"));
                this.showMessage("오토메이터가 삭제되었습니다.");
                break;
        }
        this.close();
    }
    ...
    render() {
        let html_deleteUser =
            <div className="div-modal-popup" style={{ display: this.state.isShow ? "flex" : "none", height: "100%" }}>
                            ...
                            <div className="div-modal-radio-group-delete">
                                <div className="w-form">
                                    <form id="email-form-7" name="email-form-7" data-name="Email Form 7">
                                        ...
                                        <div className="w-radio" style={{ marginTop: 10, marginBottom: -10 }}><input type="radio" style={{ marginLeft: 0 }} id="radio-4" name="radio" value={"deletecompletly"} onClick={this.radioClick} defaultValue="Radio" data-name="Radio 4" className="w-radio-input" /><label htmlFor="radio-4" className="w-form-label">목록에서 삭제후 에이전트 삭제하기</label></div>
                                    </form>
                                </div>
                            </div>
                            <div className="div-block-39"><a href="#" onClick={this.close} className="button-grey-rounded w-button">취소</a>
        ...
        let html_automator_exit =
            <div className="div-modal-popup" style={{ display: this.state.isShow ? "flex" : "none", height: "100%" }}>
                <div className="div-login-middle" style={{ zIndex: 9999 }}>
                    <div className="div-modal-popup-small" >
                        <div className="div-popup-group-remove">
                            <div className="div-block-38">
                                <img src="../images/alarm.png" width={31} height={31} />
        ...
        let html_automator_saveas =
            <div className="div-modal-popup" style={{ display: this.state.isShow ? "flex" : "none", height: "100%", zIndex: 9999 }}>
                <div className="div-login-middle" style={{ zIndex: 9999 }}>
                    <div className="div-modal-popup-small" style={{ height: 285, marginRight: 0 }}>
                        <div className="div-popup-group-remove">
